...
func (s *TelegramService) StartRun() {
	...
	for update := range updates {
		...
		case "github":
			msg.Text = `
👩🏻‍💻 Here's the link to the project: https://github.com/kali-linux-ir/x-ui/
...
📍 Github   : https://github.com/kali-linux-ir
📞 Telegram: @Free_HTTPCustom (Contact for any issues. Please be patient. As I am a student, I may not be able to reply immediately.)
📧 Email   : ?
            `
		default:
